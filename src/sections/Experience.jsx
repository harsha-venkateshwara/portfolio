...
export default function Experience() {
  const roles = [
    ...
    {
      role: "Machine Learning Engineer (Research & Systems)",
      company: "Kyono Software Pvt. Ltd.",
      dates: "Jun 2022 – Jul 2023",
      logo: "/images/logos/kyono.png",
      bullets: [
        "Developed a value-model based RL algorithm inspired by VAPO to improve long-horizon credit assignment over GRPO, achieving higher token efficiency and more stable training dynamics.",
        "Implemented Expert Parallelism with overlapping compute/communication, delivering a 30% faster MoE forward pass and a 50% reduction in activation memory for SwiGLU layers.",
        "Built an AutoInstall pipeline to convert raw codebases into runnable RL training tasks, including dependency resolution, package installation, and runnability checks in an existing sandbox system.",
      ],
      tags: [
