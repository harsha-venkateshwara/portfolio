...
Current role: Graduate Research Assistant, Research Foundation for SUNY (Jan 2026 to present, Buffalo NY)
...
=== ABOUT ===
Harsha is an AI/ML Engineer pursuing an MS in Computer Science & Engineering at the State University of New York at Buffalo (2025 to 2026, AI/ML Track). He specializes in generative AI, data science, machine learning, big data, and product development. He has cross-sector experience across energy & utilities, defense, e-commerce, and autonomous-vehicle research, with end-to-end analytics and ML solutions on large-scale datasets. His focus is practical, scalable systems: data acquisition, feature engineering, rigorous evaluation, and clear stakeholder communication. He is also active in academic research, currently building healthcare-focused projects.

Key stats: 3+ years experience, 4 industries, 8M+ records modeled, 2 countries.
...
(X1) Graduate Research Assistant — Research Foundation for SUNY — Jan 2026 to present — Buffalo, NY — CURRENT
...
(X2) Technical Associate, Machine Learning & Data Systems — Itron, Inc. — Aug 2023 to Aug 2025 — Bengaluru, India
...
(X3) Machine Learning Engineer — Kyono Software Pvt. Ltd. — Jun 2022 to Jul 2023 — Bengaluru, India
...
(X4) Data Science Intern, Air Force Defense Unit — Bharat Electronics Limited — Sep 2021 to Oct 2021 — Bengaluru, India
